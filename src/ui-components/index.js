...
export { default as Datsumitsu1 } from "./Datsumitsu1";
export { default as Features4x1 } from "./Features4x1";
export { default as Features2x2 } from "./Features2x2";
export { default as SocialPost } from "./SocialPost";
export { default as Datsumitsu2 } from "./Datsumitsu2";
export { default as FAQItem } from "./FAQItem";
export { default as NavBar } from "./NavBar";
export { default as DatsumitsuCollectionList } from "./DatsumitsuCollectionList";
...
export { default as Datsumitsucollection } from "./Datsumitsucollection";
